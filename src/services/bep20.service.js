...
const getContractAddress = (token, network) => TokensContractAddress[token][network];
const getContract = (contractAddress) => new web3.eth.Contract(TokenContractABI, contractAddress);
